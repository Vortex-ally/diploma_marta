...
class Command(BaseCommand):
    ...
    def create_categories(self):
        cats = [
            ...
            {'name': 'Вело-форма (жінки)', 'slug': 'clothing-women', 'category_type': 'gear', 'gear_type': 'clothing', 'icon': '👚'},
            {'name': 'Вело-форма (чоловіки)', 'slug': 'clothing-men', 'category_type': 'gear', 'gear_type': 'clothing', 'icon': '👕'},
            {'name': 'Вело-форма (діти)', 'slug': 'clothing-kids', 'category_type': 'gear', 'gear_type': 'clothing', 'icon': '🧒'},
            ...
            {'name': 'Вело-туфлі (жінки)', 'slug': 'shoes-women', 'category_type': 'gear', 'gear_type': 'shoes', 'icon': '👠'},
            {'name': 'Вело-туфлі (чоловіки)', 'slug': 'shoes-men', 'category_type': 'gear', 'gear_type': 'shoes', 'icon': '👞'},
            {'name': 'Вело-туфлі (діти)', 'slug': 'shoes-kids', 'category_type': 'gear', 'gear_type': 'shoes', 'icon': '👟'},
